    ...
    <>
      ...
      {isOpenMenu && (
        <ul
          ...
          className="absolute left-0 top-26 w-full font-semibold bg-secondary border border-light-gray shadow-lg shadow-primary/40 p-4 rounded-lg transition-transform duration-300"
